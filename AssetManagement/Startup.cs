...
using SwaggerOptions = AssetManagement.option.SwaggerOptions;
using AssetManagement.Installers;
...
namespace AssetManagement
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(options => options.WithOrigins(corsOptions.Origins).AllowAnyHeader().AllowAnyMethod());
